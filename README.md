...
Qwen3.6 speculative decoding requires `SGLANG_ENABLE_SPEC_V2=1` and `MAMBA_SCHEDULER_STRATEGY=extra_buffer` when radix cache is enabled. Keep `SPECULATIVE_EAGLE_TOPK=1` with SpecV2.
